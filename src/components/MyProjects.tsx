    ...
    <section id="myProjects-section" className="m-20 flex flex-col gap-5">
      ...
      <article className="flex gap-5 rounded-2xl border-4 border-teal-800 p-5">
        ...
        >
          <img
            src={myWorld}
            alt="myWorld"
            className="max-w-[820px] rounded-2xl transition-all duration-300 filter brightness-100 group-hover:brightness-50"
          />
      ...
      <article className="flex gap-5 rounded-2xl border-4 border-teal-800 p-5">
        <div>
          ...
          <p>
            Con control de estados globales para guardar tus personajes favoritos usando Redux, y haciendo
            peticiones asíncronas a un backend para almacenar los favoritos.
            También se pueden ordenar los favoritos en ascendente o descendente
            y por género.
          </p>
        </div>
      <video
        src={myVideo}
        controls
        className="w-1/2 rounded-2xl transition-all duration-300 filter brightness-100 group-hover:brightness-50"
      />
      </article>
    </section>
  );
