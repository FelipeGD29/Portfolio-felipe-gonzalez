...
const NavBar: React.FC<reactFcWithSmoothScrollFunction> = ({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={() => smoothScroll("aboutMe-section", 0, 1000)}
        className={`transition-colors duration-500 cursor-pointer ${
      ...
      <div className="flex gap-2">
        <a href="http://www.linkedin.com/in/felipe-gonzález-delgado-834950212/" target="_blank">
          <svg
            fill="white"
            className="transition-colors duration-500 hover:fill-teal-800"
        ...
        <a className="text-white flex items-center gap-2 group" href={CV} download="Felipe-Gonzalez.pdf">
          <svg
            className="transition-color duration-500 group-hover:fill-teal-800"
            fill="white"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
          ...
          <p className="cursor-pointer transition-color duration-500 group-hover:text-teal-800">
            Descargar CV
          </p>
        </a>
      </div>
